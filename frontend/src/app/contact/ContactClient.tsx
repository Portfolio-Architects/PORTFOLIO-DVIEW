      ...
      <div className="md:col-span-2 bg-surface p-6 sm:p-8 rounded-2xl border border-border shadow-sm">
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-10 text-center animate-in fade-in duration-300">
            <div className="w-16 h-16 bg-[#e6f4f2] dark:bg-[#ea6100]/10 text-[#ea6100] dark:text-[#ea6100] rounded-full flex items-center justify-center mb-4 shadow-inner">
              <Send size={28} className="ml-0.5 mt-0.5 text-[#ea6100] dark:text-[#ea6100]" />
            </div>
