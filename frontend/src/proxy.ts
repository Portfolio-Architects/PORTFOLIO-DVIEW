...
export async function proxy(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    frame-src 'self' https://www.google.com https://www.youtube.com https://portfolio-dtdls.firebaseapp.com https://apis.google.com https://www.recaptcha.net https://*.kakao.com https://googleads.g.doubleclick.net https://*.googlesyndication.com https://*.doubleclick.net;
    object-src 'none';
    base-uri 'self';
