...
export async function createScoutingReport(
  ...
  try {
    return await ReportRepo.saveScoutingReport(validated.data);
  } catch (error) {
...
export async function updateScoutingReport(
  ...
  try {
    await ReportRepo.updateScoutingReport(reportId, validated.data);
  } catch (error) {
...
export async function createFieldReport(
  ...
  await ReportRepo.saveFieldReport({
