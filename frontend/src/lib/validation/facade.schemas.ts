...
export const ObjectiveMetricsSchema = z.object({
  brand: z.string().nullable().optional().transform(v => v ?? ''),
  householdCount: z.number().int().nonnegative().nullable().optional().transform(v => v ?? 0),
  far: z.number().nonnegative().nullable().optional().transform(v => v ?? 0),
  bcr: z.number().nonnegative().nullable().optional().transform(v => v ?? 0),
  parkingCount: z.number().nullable().optional().transform(v => v ?? undefined),
  parkingPerHousehold: z.number().nonnegative().nullable().optional().transform(v => v ?? 0),
  yearBuilt: z.preprocess((val) => {
    ...
    return val;
  }, z.number().int().nullable().optional()).transform(v => v ?? 0),
  minFloor: z.number().nullable().optional().transform(v => v ?? undefined),
  maxFloor: z.number().nullable().optional().transform(v => v ?? undefined),
  coordinates: z.string().nullable().optional().transform(v => v ?? undefined),
  distanceToElementary: z.number().nonnegative().nullable().optional().transform(v => v ?? 9999),
  distanceToMiddle: z.number().nonnegative().nullable().optional().transform(v => v ?? 9999),
  distanceToHigh: z.number().nonnegative().nullable().optional().transform(v => v ?? 9999),
  distanceToSubway: z.number().nonnegative().nullable().optional().transform(v => v ?? 9999),
  academyDensity: z.number().nonnegative().nullable().optional().transform(v => v ?? 0),
  academyCategories: z.record(z.string(), z.number()).nullable().optional().transform(v => v ?? {}),
  restaurantDensity: z.number().nullable().optional().transform(v => v ?? undefined),
  restaurantCategories: z.record(z.string(), z.number()).nullable().optional().transform(v => v ?? undefined),
  distanceToIndeokwon: z.number().nullable().optional().transform(v => v ?? undefined),
  distanceToTram: z.number().nullable().optional().transform(v => v ?? undefined),
  distanceToStarbucks: z.number().nullable().optional().transform(v => v ?? undefined),
  starbucksName: z.string().nullable().optional().transform(v => v ?? undefined),
  starbucksAddress: z.string().nullable().optional().transform(v => v ?? undefined),
  starbucksCoordinates: z.string().nullable().optional().transform(v => v ?? undefined),
  distanceToMcDonalds: z.number().nullable().optional().transform(v => v ?? undefined),
  mcdonaldsName: z.string().nullable().optional().transform(v => v ?? undefined),
  mcdonaldsAddress: z.string().nullable().optional().transform(v => v ?? undefined),
  mcdonaldsCoordinates: z.string().nullable().optional().transform(v => v ?? undefined),
  distanceToOliveYoung: z.number().nullable().optional().transform(v => v ?? undefined),
  oliveYoungName: z.string().nullable().optional().transform(v => v ?? undefined),
  oliveYoungAddress: z.string().nullable().optional().transform(v => v ?? undefined),
  oliveYoungCoordinates: z.string().nullable().optional().transform(v => v ?? undefined),
  distanceToDaiso: z.number().nullable().optional().transform(v => v ?? undefined),
  daisoName: z.string().nullable().optional().transform(v => v ?? undefined),
  daisoAddress: z.string().nullable().optional().transform(v => v ?? undefined),
  daisoCoordinates: z.string().nullable().optional().transform(v => v ?? undefined),
  distanceToSupermarket: z.number().nullable().optional().transform(v => v ?? undefined),
  supermarketName: z.string().nullable().optional().transform(v => v ?? undefined),
  supermarketAddress: z.string().nullable().optional().transform(v => v ?? undefined),
  supermarketCoordinates: z.string().nullable().optional().transform(v => v ?? undefined),
  distanceToPark: z.number().nullable().optional().transform(v => v ?? undefined),
  nearestSchoolNames: z.object({
    elementary: z.string().nullable().optional().transform(v => v ?? ''),
    middle: z.string().nullable().optional().transform(v => v ?? ''),
    high: z.string().nullable().optional().transform(v => v ?? ''),
  }).nullable().optional().transform(v => v ?? { elementary: '', middle: '', high: '' }),
  nearestStationName: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestStationLine: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestStationCoords: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestIndeokwonStationName: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestIndeokwonLine: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestIndeokwonCoords: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestTramStationName: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestTramLine: z.string().nullable().optional().transform(v => v ?? undefined),
  nearestTramCoords: z.string().nullable().optional().transform(v => v ?? undefined),
});
