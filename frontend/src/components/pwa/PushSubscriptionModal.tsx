        ...
        <div className="px-6 pt-6 pb-2">
          ...
          <div className="flex justify-between items-start mb-5">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-emerald-50 dark:bg-[#003829]/50 rounded-[18px] flex items-center justify-center text-emerald-600 dark:text-[#ea6100] shrink-0">
          ...
          <div className="bg-[#e8f8f5] dark:bg-[#002f23] rounded-2xl p-5 border border-[#ea6100]/15 text-left mb-6 relative overflow-hidden">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-3.5 px-4 bg-[#c44d00] dark:bg-[#ff8f00] disabled:bg-gray-300 dark:disabled:bg-zinc-800 disabled:text-gray-500 text-surface font-black rounded-2xl hover:bg-[#9e3c00] dark:hover:bg-[#c44d00] active:scale-[0.98] transition-all shadow-md text-[13.5px] cursor-pointer flex items-center justify-center gap-1.5"
            >
              {submitting ? (
