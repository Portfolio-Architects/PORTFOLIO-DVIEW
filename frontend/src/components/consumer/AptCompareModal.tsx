            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/10 border border-emerald-500/20 dark:border-emerald-500/10 rounded-2xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col items-end shrink-0 relative">
                  ...
                  <div className={`mt-1.5 text-[11px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2.5 py-1.5 rounded-lg border border-emerald-500/20 text-right transition-all duration-300 ${
                    isCopied ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-1 invisible absolute'
