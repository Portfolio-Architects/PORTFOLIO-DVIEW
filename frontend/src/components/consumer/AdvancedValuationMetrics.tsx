                    ...
                    {(() => {
                      ...
                      return (
                        <div className="w-full flex flex-col gap-4">
                          {avg1MSale > 0 && (
                            <div className={`w-full flex flex-col items-center p-5 rounded-2xl shadow-sm border ${
                              diff1MAmount > 0 
                              ...
                              <div className="flex items-center gap-1.5 text-[14px] font-bold text-secondary mb-2">
                                <span className={`w-1.5 h-1.5 rounded-full ${diff1MAmount > 0 ? 'bg-rose-500' : 'bg-teal-500'}`} />
                                기준가 (1개월 평균): <span className="text-primary font-black ml-0.5">{formatPrice(avg1MSale)}</span>
                              </div>
                              <div className={`px-4 py-2 rounded-xl text-[14.5px] font-extrabold shadow-sm text-center break-keep ${
                          ...
                          {avg3MSale > 0 && (
                            <div className={`w-full flex flex-col items-center p-5 rounded-2xl shadow-sm border ${
                              ...
                              <div className="flex items-center gap-1.5 text-[14px] font-bold text-secondary mb-2">
                                <span className={`w-1.5 h-1.5 rounded-full ${diff3MAmount > 0 ? 'bg-rose-500' : 'bg-teal-500'}`} />
