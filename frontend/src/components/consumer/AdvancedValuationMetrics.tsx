                      ...
                      <div className="relative">
                        ...
                        <div className="bg-body/45 dark:bg-zinc-800/20 border border-border/60 rounded-xl p-3.5 flex flex-col gap-1 hover:bg-body/60 dark:hover:bg-zinc-800/30 transition-colors">
                          ...
                          <button 
                            ...
                            className="text-[11.5px] md:text-[12px] text-tertiary leading-relaxed hover:underline hover:text-[#008262] dark:hover:text-[#00d29d] transition-colors cursor-pointer text-left font-medium block w-full bg-transparent border-none p-0"
                          >
                      ...
                      <div className="relative">
                        ...
                        <div className="bg-body/45 dark:bg-zinc-800/20 border border-border/60 rounded-xl p-3.5 flex flex-col gap-1 hover:bg-body/60 dark:hover:bg-zinc-800/30 transition-colors">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[14px] font-extrabold text-[#00b386]">{dcf.capRate.toFixed(2)}%</span>
                          </div>
                          <div className="text-[11.5px] md:text-[12px] text-tertiary leading-relaxed">
