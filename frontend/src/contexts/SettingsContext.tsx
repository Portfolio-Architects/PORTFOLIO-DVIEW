...
export const AreaUnitSchema = z.enum(['m2', 'pyeong']);
export const ThemeSchema = z.enum(['light', 'dark', 'system']);

export interface SettingsValueContextType {
  areaUnit: AreaUnit;
...
export interface SettingsUiContextType {
...
export function useSettingsValues(): SettingsValueContextType {
...
export function useSettings(): SettingsValueContextType & SettingsUiContextType {
